                            ...
                            <form action="../Controlador/controllerController.php" class="row mx-auto" method="POST">
                                <input type='hidden' name='action' value='registrar'>
                                    <div class="col-12">
                                            ...
                                            <div class="col-sm-8">
                                            <input require type="text" class="form-control" name="nameControllerView" id="nameControllerView">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="passw" class="col-sm-4 col-form-label">Fecha Creación:</label>
                                            <div class="col-sm-8">
                                            <input require type="datetime" class="form-control" value="<?php echo date('Y-m-d H:i:s'); ?>" name="createdAt" id="createdAt">
                                            </div>
                                        </div>
                                        <div class="form-group row">
