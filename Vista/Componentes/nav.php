...
<a class="navbar-brand"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" 
        aria-haspopup="true" aria-expanded="false">Alquileres Autos</a>
        <div class="dropdown-menu bg-dark">
          <a class="nav-link dropdown-item" href="?controller=alquilerAutos&action=register">Registrar alquiler</a>
          <a class="nav-link dropdown-item" href="?controller=alquilerAutos&action=index">Ver alquileres</a>
        </div>
      </li>
      <li class="nav-item">
